...
if($_POST)
{
    ...
    $selectquery = mysqli_query($connection, "select * from admin where admin_email='{$ad_email}' and admin_password='{$ad_password}'") or die(mysqli_error($connection));
...
<div id="id01" class="">
    ...
    <div class="imgcontainer">
        ...
        <img src="./myimages/user1.png" style="height: 180px; width: 200px;" alt="Avatar" class="avatar">
    </div>
