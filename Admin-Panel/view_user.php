                                        ...
                                        echo "<tr>";
                                          ...
                                          echo "<td>{$productrow['name']}</td>";
                                            echo "<td>{$productrow['email']}</td>";
                                              echo "<td>{$productrow['phone_no']}</td>";

                                        echo "<td> <a href='view_user.php?did=" . $productrow['user_id'] . "' onClick=\"javascript:return confirm('Are you sure you want to delete this?');\"><img style='width:16px;' src='myimages/delete-icon.png'> Delete</a>   </td>";
                                        echo "</tr>";
                                    }
                                    ?>
